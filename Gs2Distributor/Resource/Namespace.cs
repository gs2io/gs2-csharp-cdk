...
namespace Gs2Cdk.Gs2Distributor.Resource
{
    public class Namespace : CdkResource
    {
        ...
        private readonly NotificationSetting _autoRunStampSheetNotification;
        ...
        ): base("Distributor_Namespace_" + name) {
            this._stack = stack;
            this._name = name;
            this._description = description;
            this._assumeUserId = assumeUserId;
            this._autoRunStampSheetNotification = autoRunStampSheetNotification;
        ...
        public override Dictionary<string, object> Properties() {
            ...
            if (this._autoRunStampSheetNotification != null) {
                properties["AutoRunStampSheetNotification"] = this._autoRunStampSheetNotification.Properties();
            }
