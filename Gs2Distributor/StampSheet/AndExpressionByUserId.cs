...
{
    public class AndExpressionByUserId : VerifyAction {
        ...
        public static AndExpressionByUserId FromProperties(Dictionary<string, object> properties) {
            try {
                return new AndExpressionByUserId(
