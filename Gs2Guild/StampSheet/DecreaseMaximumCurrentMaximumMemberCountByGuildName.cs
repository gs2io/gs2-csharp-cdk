...
{
    public class DecreaseMaximumCurrentMaximumMemberCountByGuildName : ConsumeAction {
        ...
        public static DecreaseMaximumCurrentMaximumMemberCountByGuildName FromProperties(Dictionary<string, object> properties) {
            try {
