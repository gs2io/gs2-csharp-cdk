...
{
    public class SetCounterByUserId : AcquireAction {
        private string namespaceName;
        private string counterName;
        private string userId;
        private ScopedValue[] values;
        ...
        public static SetCounterByUserId FromProperties(Dictionary<string, object> properties) {
            try {
                return new SetCounterByUserId(
                    ...
                    {
                        return properties.TryGetValue("values", out var values) ? values switch {
