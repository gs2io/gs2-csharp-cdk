...
{
    public class VerifyGlobalRankingScoreByUserId : VerifyAction {
        private string namespaceName;
        private string userId;
        private string rankingName;
        private VerifyGlobalRankingScoreByUserIdVerifyType? verifyType;
        private long score;
        ...
        public static VerifyGlobalRankingScoreByUserId FromProperties(Dictionary<string, object> properties) {
            try {
                return new VerifyGlobalRankingScoreByUserId(
                    (string)properties["namespaceName"],
                    (string)properties["rankingName"],
                    new Func<VerifyGlobalRankingScoreByUserIdVerifyType>(() =>
                    {
                        return properties["verifyType"] switch {
                            VerifyGlobalRankingScoreByUserIdVerifyType e => e,
                            string s => VerifyGlobalRankingScoreByUserIdVerifyTypeExt.New(s),
                            _ => VerifyGlobalRankingScoreByUserIdVerifyType.Less
                        };
                    })(),
                    new Func<long>(() =>
                    {
