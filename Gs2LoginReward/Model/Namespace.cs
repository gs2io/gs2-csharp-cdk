    ...
    public class Namespace : CdkResource {
        ...
        public Namespace MasterData(
            ...
            (new CurrentMasterData(
                ...
                new Func<BonusModel[]>(() =>
                {
                    return properties["bonusModels"] switch {
                        BonusModel[] v => v,
                        List<BonusModel> v => v.ToArray(),
                        Dictionary<string, object>[] v => v.Select(BonusModel.FromProperties).ToArray(),
                        List<Dictionary<string, object>> v => v.Select(BonusModel.FromProperties).ToArray(),
                        _ => null,
                    };
                })()
            )).AddDependsOn(
