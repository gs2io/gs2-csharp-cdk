...
{
    public class VerifyStaminaMaxValueByUserId : VerifyAction {
        private string namespaceName;
        private string userId;
        private string staminaName;
        private VerifyStaminaMaxValueByUserIdVerifyType? verifyType;
        private int value;
        ...
        public static VerifyStaminaMaxValueByUserId FromProperties(Dictionary<string, object> properties) {
            try {
                return new VerifyStaminaMaxValueByUserId(
                    (string)properties["namespaceName"],
                    (string)properties["staminaName"],
                    new Func<VerifyStaminaMaxValueByUserIdVerifyType>(() =>
                    {
                        return properties["verifyType"] switch {
                            VerifyStaminaMaxValueByUserIdVerifyType e => e,
                            string s => VerifyStaminaMaxValueByUserIdVerifyTypeExt.New(s),
                            _ => VerifyStaminaMaxValueByUserIdVerifyType.Less
                        };
                    })(),
                    new Func<int>(() =>
                    {
        ...
        public override string Action() {
            return "Gs2Stamina:VerifyStaminaMaxValueByUserId";
        }
