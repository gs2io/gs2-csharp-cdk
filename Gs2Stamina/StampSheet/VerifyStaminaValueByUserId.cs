...
{
    public class VerifyStaminaValueByUserId : VerifyAction {
        private string namespaceName;
        private string userId;
        private string staminaName;
        private VerifyStaminaValueByUserIdVerifyType? verifyType;
        private int value;
        ...
        public static VerifyStaminaValueByUserId FromProperties(Dictionary<string, object> properties) {
            try {
                return new VerifyStaminaValueByUserId(
                    (string)properties["namespaceName"],
                    (string)properties["staminaName"],
                    new Func<VerifyStaminaValueByUserIdVerifyType>(() =>
                    {
                        return properties["verifyType"] switch {
                            VerifyStaminaValueByUserIdVerifyType e => e,
                            string s => VerifyStaminaValueByUserIdVerifyTypeExt.New(s),
                            _ => VerifyStaminaValueByUserIdVerifyType.Less
                        };
                    })(),
                    new Func<int>(() =>
                    {
