...
{
    public class VerifyStaminaOverflowValueByUserId : VerifyAction {
        private string namespaceName;
        private string userId;
        private string staminaName;
        private VerifyStaminaOverflowValueByUserIdVerifyType? verifyType;
        private int value;
        ...
        public static VerifyStaminaOverflowValueByUserId FromProperties(Dictionary<string, object> properties) {
            try {
                return new VerifyStaminaOverflowValueByUserId(
                    (string)properties["namespaceName"],
                    (string)properties["staminaName"],
                    new Func<VerifyStaminaOverflowValueByUserIdVerifyType>(() =>
                    {
                        return properties["verifyType"] switch {
                            VerifyStaminaOverflowValueByUserIdVerifyType e => e,
                            string s => VerifyStaminaOverflowValueByUserIdVerifyTypeExt.New(s),
                            _ => VerifyStaminaOverflowValueByUserIdVerifyType.Less
                        };
                    })(),
                    new Func<int>(() =>
                    {
        ...
        public override string Action() {
            return "Gs2Stamina:VerifyStaminaOverflowValueByUserId";
        }
