...
namespace Gs2Cdk.Gs2Dictionary.Resource
{
    public class Namespace : CdkResource
    {
        ...
        private readonly ScriptSetting _entryScript;
        private readonly ScriptSetting _duplicateEntryScript;
        ...
        ): base("Dictionary_Namespace_" + name) {
            this._stack = stack;
            this._name = name;
            this._description = description;
            this._entryScript = entryScript;
            this._duplicateEntryScript = duplicateEntryScript;
        ...
        public override Dictionary<string, object> Properties() {
            ...
            if (this._entryScript != null) {
                properties["EntryScript"] = this._entryScript.Properties();
            }
            if (this._duplicateEntryScript != null) {
                properties["DuplicateEntryScript"] = this._duplicateEntryScript.Properties();
            }
