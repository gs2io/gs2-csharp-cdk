...
namespace Gs2Cdk.Gs2Inbox.Resource
{
    ...
    {
        private readonly string _version = "2020-03-12";
        private readonly string _namespaceName;
        private readonly GlobalMessage[] _globalMessages;

        public CurrentMasterData(
                Stack stack,
                string namespaceName,
                GlobalMessage[] globalMessages
        ): base("Inbox_CurrentMessageMaster_" + namespaceName) {
        ...
        public override Dictionary<string, object> Properties() {
            return new Dictionary<string, object>() {
                ...
                {"Settings", new Dictionary<string, object>() {
                    ...
                    {"globalMessages", this._globalMessages.Select(v => v.Properties()).ToArray()},
                }},
            };
        }
    }
