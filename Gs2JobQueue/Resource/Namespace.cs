...
namespace Gs2Cdk.Gs2JobQueue.Resource
{
    public class Namespace : CdkResource
    {
        ...
        private readonly NotificationSetting _pushNotification;
        private readonly NotificationSetting _runNotification;
        ...
        public override Dictionary<string, object> Properties() {
            ...
            if (this._pushNotification != null) {
                properties["PushNotification"] = this._pushNotification.Properties();
            }
            if (this._runNotification != null) {
                properties["RunNotification"] = this._runNotification.Properties();
            }
